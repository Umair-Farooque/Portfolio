...
export const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "farooq.intellecta@gmail.com", href: "mailto:farooq.intellecta@gmail.com" },
    { icon: Phone, label: "Phone", value: "+92 308 4624629", href: "tel:+923084624629" },
    { icon: MapPin, label: "Location", value: "Islamabad, Pakistan", href: "#" },
  ];

  const socialLinks = [
    { icon: Github, label: "GitHub", href: "https://github.com/Umair-Farooque" },
    { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/umairfaroq/" },
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs
      .sendForm(
        "service_t9e315i", // replace with EmailJS Service ID
        "template_7cdcsj9", // replace with EmailJS Template ID
        formRef.current,
              ...
              <CardContent className="p-6">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button
                    type="submit"
                    disabled={loading}
                    className="w-full bg-white/20 hover:bg-white/30 text-white py-3 transition-all duration-300 hover:scale-105 border border-white/50 rounded-xl shadow-lg hover:shadow-white/25"
                  >
